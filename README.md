...
罵尻ロマ子（Romaco-sama）Creative Showcaseです。罵尻ロマ子様の4コマ漫画、動く漫画、料理シネマ、PV、講座動画などを並べ、Romaco-samaコミュニティに「愛と罵倒が最新AIでどう動き出すか」を共有する画面として設計しています。
...
- `PUBLIC_ROMACO_GAME_URL`: Romaco-samaゲーム。
- `PUBLIC_ROMACO_SUBSTACK_URL`: Romaco-sama Substack。
